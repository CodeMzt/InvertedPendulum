...
* @return   无
*/
void OLED_Print(uint8_t x,uint8_t y,uint8_t FontSize,const char* Str, ...) {
    char display_buf[128];
    va_list args;
    va_start(args, Str);
    vsprintf(display_buf, Str, args);
    OLED_ShowString(x,y,display_buf,FontSize);
    va_end(args);
}
